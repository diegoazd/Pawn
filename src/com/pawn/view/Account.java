...
import com.pawn.utils.GenerateResponse;
    ...
    public ComplexResponse testPost(TestBean report){
		...
		@Consumes(MediaType.APPLICATION_JSON)
     	public ComplexResponse create(User user){
     	  ...
     	  if(apiToken != "")
     		cr = GenerateResponse.generateResponse(201, "Registro exitoso", apiToken);
     	  else
     		cr = GenerateResponse.generateResponse(400, "Error en el registro", null);
