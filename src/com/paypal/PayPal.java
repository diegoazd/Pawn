...
*********************************************************************************/
public HashMap callShortcutExpressCheckout( HttpServletRequest request, String returnURL, String cancelURL)
{
...
/*********************************************************************************
  ...
  * Output: Returns a HashMap object containing the response from the server.
*********************************************************************************/
public HashMap<String, String> callMarkExpressCheckout(HttpServletRequest request, String returnURL, String cancelURL)
{
	...
	//------------------------------------------------------------------------------------------------------------------------------------
			...
			String nvpstr="";
			//Mandatory parameters for SetExpressCheckout API call
			if(isSet(session.getAttribute("PAYMENTREQUEST_0_AMT")))
			{
				nvpstr = "&PAYMENTREQUEST_0_AMT="+ session.getAttribute("PAYMENTREQUEST_0_AMT");
				session.setAttribute("Payment_Amount", session.getAttribute("PAYMENTREQUEST_0_AMT"));
			}

			if(isSet(session.getAttribute("paymentType")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_PAYMENTACTION=" +  session.getAttribute("paymentType");
				session.setAttribute("PaymentType", session.getAttribute("paymentType"));
			}
			...
			{
				nvpstr +=  "&PAYMENTREQUEST_0_CURRENCYCODE=" + session.getAttribute("currencyCodeType");
				session.setAttribute("currencyCodeType", session.getAttribute("currencyCodeType"));	
			} 

			if(isSet(session.getAttribute("PAYMENTREQUEST_0_ITEMAMT")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_ITEMAMT=" + session.getAttribute("PAYMENTREQUEST_0_ITEMAMT");
				session.setAttribute("itemAmt", session.getAttribute("PAYMENTREQUEST_0_ITEMAMT"));
			}

			if(isSet(session.getAttribute("PAYMENTREQUEST_0_TAXAMT")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_TAXAMT=" + session.getAttribute("PAYMENTREQUEST_0_TAXAMT");
				session.setAttribute("taxAmt", session.getAttribute("PAYMENTREQUEST_0_TAXAMT"));
			}

			if(isSet(session.getAttribute("PAYMENTREQUEST_0_SHIPPINGAMT")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_SHIPPINGAMT=" + session.getAttribute("PAYMENTREQUEST_0_SHIPPINGAMT");
				session.setAttribute("shippingAmt", session.getAttribute("PAYMENTREQUEST_0_SHIPPINGAMT"));
			}

			if(isSet(session.getAttribute("PAYMENTREQUEST_0_HANDLINGAMT")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_HANDLINGAMT=" + session.getAttribute("PAYMENTREQUEST_0_HANDLINGAMT");
				session.setAttribute("handlingAmt", session.getAttribute("PAYMENTREQUEST_0_HANDLINGAMT"));
			}

			if(isSet(session.getAttribute("PAYMENTREQUEST_0_SHIPDISCAMT")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_SHIPDISCAMT=" + session.getAttribute("PAYMENTREQUEST_0_SHIPDISCAMT");
				session.setAttribute("shippingDiscAmt", session.getAttribute("PAYMENTREQUEST_0_SHIPDISCAMT"));
			}

			if(isSet(session.getAttribute("PAYMENTREQUEST_0_INSURANCEAMT")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_INSURANCEAMT=" + session.getAttribute("PAYMENTREQUEST_0_INSURANCEAMT");
				session.setAttribute("insuranceAmt", session.getAttribute("PAYMENTREQUEST_0_INSURANCEAMT"));
			}

			if(isSet(session.getAttribute("L_PAYMENTREQUEST_0_NAME0")))
			nvpstr +=  "&L_PAYMENTREQUEST_0_NAME0=" + session.getAttribute("L_PAYMENTREQUEST_0_NAME0");

			if(isSet(session.getAttribute("L_PAYMENTREQUEST_0_NUMBER0")))
			nvpstr +=  "&L_PAYMENTREQUEST_0_NUMBER0=" + session.getAttribute("L_PAYMENTREQUEST_0_NUMBER0");

			if(isSet(session.getAttribute("L_PAYMENTREQUEST_0_DESC0")))
			nvpstr +=  "&L_PAYMENTREQUEST_0_DESC0=" + session.getAttribute("L_PAYMENTREQUEST_0_DESC0");
			
			if(isSet(session.getAttribute("PAYMENTREQUEST_0_ITEMAMT")))
			nvpstr +=  "&L_PAYMENTREQUEST_0_AMT0=" + session.getAttribute("PAYMENTREQUEST_0_ITEMAMT");

			if(isSet(session.getAttribute("L_PAYMENTREQUEST_0_QTY0")))
			nvpstr +=  "&L_PAYMENTREQUEST_0_QTY0=" + session.getAttribute("L_PAYMENTREQUEST_0_QTY0");

			if(isSet(session.getAttribute("LOGOIMG")))
			...
			if(isSet(request.getParameter("L_PAYMENTREQUEST_FIRSTNAME"))){
				String fullname = (String) request.getParameter("L_PAYMENTREQUEST_FIRSTNAME");
				if(isSet(request.getParameter("L_PAYMENTREQUEST_LASTNAME")))
					fullname = fullname + " "+ (String) request.getParameter("L_PAYMENTREQUEST_LASTNAME");
				
				nvpstr +=  "&PAYMENTREQUEST_0_SHIPTONAME=" + fullname;
				session.setAttribute("shipToName", fullname);	
			} 
			
			if(isSet(request.getParameter("PAYMENTREQUEST_0_SHIPTOSTREET")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_SHIPTOSTREET=" + request.getParameter("PAYMENTREQUEST_0_SHIPTOSTREET");
				session.setAttribute("shipToAddress", request.getParameter("PAYMENTREQUEST_0_SHIPTOSTREET"));
			}
			
			if(isSet(request.getParameter("PAYMENTREQUEST_0_SHIPTOSTREET2")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_SHIPTOSTREET2=" + request.getParameter("PAYMENTREQUEST_0_SHIPTOSTREET2");
				session.setAttribute("shipToAddress2", request.getParameter("PAYMENTREQUEST_0_SHIPTOSTREET2"));
			}
			
			if(isSet(request.getParameter("PAYMENTREQUEST_0_SHIPTOCITY")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_SHIPTOCITY=" + request.getParameter("PAYMENTREQUEST_0_SHIPTOCITY");
				session.setAttribute("shipToCity", request.getParameter("PAYMENTREQUEST_0_SHIPTOCITY"));
			}
			
			if(isSet(request.getParameter("PAYMENTREQUEST_0_SHIPTOSTATE")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_SHIPTOSTATE=" + request.getParameter("PAYMENTREQUEST_0_SHIPTOSTATE");
				session.setAttribute("shipToState", request.getParameter("PAYMENTREQUEST_0_SHIPTOSTATE"));
			}
			if(isSet(request.getParameter("PAYMENTREQUEST_0_SHIPTOZIP")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_SHIPTOZIP=" + request.getParameter("PAYMENTREQUEST_0_SHIPTOZIP");
				session.setAttribute("shipToZip", request.getParameter("PAYMENTREQUEST_0_SHIPTOZIP"));
			}
			if(isSet(request.getParameter("PAYMENTREQUEST_0_SHIPTOCOUNTRY")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_SHIPTOCOUNTRY=" + request.getParameter("PAYMENTREQUEST_0_SHIPTOCOUNTRY");
				session.setAttribute("shipToCountry", request.getParameter("PAYMENTREQUEST_0_SHIPTOCOUNTRY"));
			}
			if(isSet(request.getParameter("PAYMENTREQUEST_0_SHIPTOPHONENUM")))
			{
				nvpstr +=  "&PAYMENTREQUEST_0_SHIPTOPHONENUM=" + request.getParameter("PAYMENTREQUEST_0_SHIPTOPHONENUM");
				session.setAttribute("shipToPhone", request.getParameter("PAYMENTREQUEST_0_SHIPTOPHONENUM"));
			}
...
*********************************************************************************/
public HashMap confirmPayment(HttpSession session, String finalPaymentAmount, String serverName)
{
...
public void setUserActionFlag(String userActionFlag) {
